    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookDomains", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BookDomainId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    BookLanguageId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Books_BookDomains_BookDomainId",
                        column: x => x.BookDomainId,
                        principalTable: "BookDomains",
                        principalColumn: "Id");
                    table.ForeignKey(
